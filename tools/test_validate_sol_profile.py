...
class SolProfileManifestIntegrityTest(unittest.TestCase):
    def test_versioned_manifest_matches_canonical_sha_and_report(self):
        ...
        release_dir = root / "docs" / "releases" / "v2.34.3.0"
        manifest_path = release_dir / "SOL_PROFILE_V1_CORPUS_MANIFEST.json"
        report_path = release_dir / "SOL_PROFILE_V1_RESEARCH_REPORT.md"
