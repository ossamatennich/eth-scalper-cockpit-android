...
def main():
    parser=argparse.ArgumentParser();parser.add_argument("--cache",default="build/sol-profile-cache");parser.add_argument("--report",default="docs/releases/v2.34.3.0/SOL_PROFILE_V1_RESEARCH_REPORT.md");parser.add_argument("--manifest",default="docs/releases/v2.34.3.0/SOL_PROFILE_V1_CORPUS_MANIFEST.json");parser.add_argument("--end-date",default=(dt.date.today()-dt.timedelta(days=1)).isoformat());args=parser.parse_args()
