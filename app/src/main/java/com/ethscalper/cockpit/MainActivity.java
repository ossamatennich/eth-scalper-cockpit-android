...
public class MainActivity extends Activity {
    ...
    private void buildHeader() {
        ...
        TextView version = text("v2.33.1 · Dual Sleeve Diagnostic Fix", 12, MUTED, true);
    ...
    private String buildDiagnosticSummary(JSONObject s) {
        ...
        b.append("Version app: v2.33.1 Android natif · Dual Sleeve Diagnostic Fix\n");
    ...
    private String buildEngineMetricsText(JSONObject s) {
        ...
        StringBuilder b = new StringBuilder();
        b.append("ENGINE METRICS — ETH SCALPER v2.33.1\n\n");
    ...
    private String buildObservationSummaryText(JSONObject s) {
        ...
        StringBuilder b = new StringBuilder();
        b.append("PRO LABEL LAB — ETH SCALPER v2.33.1\n\n");
        if (summary != null) {
    ...
    private String buildMarketSummaryText(JSONObject s) {
        StringBuilder b = new StringBuilder("PRO LABEL LAB — MARKET RECORDER v2.33.1\n\n");
