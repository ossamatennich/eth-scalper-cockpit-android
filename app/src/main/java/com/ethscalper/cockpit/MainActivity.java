...
public class MainActivity extends Activity {
    ...
    private void buildHeader() {
        ...
        TextView version = text("v2.27.0 · Android natif", 12, MUTED, true);
    ...
    private void exportDiagnosticZip() {
        try {
            ...
            String fileName = "ETH_Scalper_Diagnostic_v2_27_0_" +
    ...
    private String buildDiagnosticSummary(JSONObject s) {
        ...
        b.append("Version app: v2.27.0 Android natif\n");
    ...
    private String buildEngineMetricsText(JSONObject s) {
        ...
        StringBuilder b = new StringBuilder();
        b.append("ENGINE METRICS — ETH SCALPER v2.27.0\n\n");
    ...
    private String buildObservationSummaryText(JSONObject s) {
        ...
        StringBuilder b = new StringBuilder();
        b.append("CLEAN C1 CANDIDATE — ETH SCALPER v2.27.0\n\n");
        if (summary != null) {
