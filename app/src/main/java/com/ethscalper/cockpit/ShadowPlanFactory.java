...
public final class ShadowPlanFactory {
    ...
    public static final class Result {
        ...
        private Result(boolean valid,String reason,ShadowPlanState state,DynamicTradePlan.Result plan,
                       ConfirmedSizing.Result sizing,ShadowNetEconomics.Result economics){
            this.valid=valid;reasonCode=reason;this.state=state;this.plan=plan;
            this.sizing=sizing;this.economics=economics;
        }
        private static Result rejected(String reason){return new Result(false,reason,null,null,null,null);}
    }
}
