...
public final class DiagnosticExportContract {
    ...
    public static final List<String> REQUIRED_FILES=DiagnosticStreamingExporter.ENTRY_NAMES;
    ...
    public static String zipPrefix(String versionName){
        ...
        return "NMC_Diagnostic_v"+versionName.replace('.','_')+"_";
    }

    public static String instructions(String versionName){return
            "Native Market Cockpit v"+versionName+" — diagnostic multi-marchés.\n"
