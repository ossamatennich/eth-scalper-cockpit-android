...
public final class V23449DeliveryConfigurationTest {
 @Test public void versionAndLabelExact()throws Exception{String s=read("app/build.gradle");assertTrue(s.contains("versionCode 23449"));assertTrue(s.contains("versionName '2.34.4.9'"));assertTrue(s.contains("NMC Stable 4.9"));}
 @Test public void workflowAndArtifactExact()throws Exception{String s=read(".github/workflows/nmc-ci.yml");assertTrue(s.contains("NMC v2.34.4.9 Stable CI"));assertTrue(s.contains("NMC-v2.34.4.9-stable-apk"));}
 ...
 @Test public void engineIdentityExact(){assertEquals("2.34.4.9",CvCorePolicy.VERSION_NAME);assertEquals("NMC_SCALP_CV_CORE_V1",CvCorePolicy.ENGINE_ID);}
