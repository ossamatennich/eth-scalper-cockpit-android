...
public final class V23449DeliveryConfigurationTest {
 @Test public void versionAndLabelExact()throws Exception{String s=read("app/build.gradle");assertTrue(s.contains("versionCode 23451"));assertTrue(s.contains("versionName '2.34.5.1'"));assertTrue(s.contains("NMC Stable 5.1"));}
 @Test public void workflowAndArtifactExact()throws Exception{String s=read(".github/workflows/nmc-ci.yml");assertTrue(s.contains("NMC v2.34.5.1 Stable CI"));assertTrue(s.contains("NMC-v2.34.5.1-stable-apk"));}
