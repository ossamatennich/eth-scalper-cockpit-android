...
public final class V23449DeliveryConfigurationTest {
 @Test public void versionAndLabelExact()throws Exception{String s=read("app/build.gradle");assertTrue(s.contains("versionCode 23452"));assertTrue(s.contains("versionName '2.34.5.2'"));assertTrue(s.contains("NMC Stable 5.2"));}
 @Test public void workflowAndArtifactExact()throws Exception{String s=read(".github/workflows/nmc-ci.yml");assertTrue(s.contains("NMC v2.34.5.2 Stable CI"));assertTrue(s.contains("NMC-v2.34.5.2-stable-apk"));}
