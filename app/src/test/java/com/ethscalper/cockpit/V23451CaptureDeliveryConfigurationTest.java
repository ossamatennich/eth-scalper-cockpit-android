...
public final class V23451CaptureDeliveryConfigurationTest {
    @Test public void releaseIdentityAndCaptureSchemaAreExact()throws Exception{String gradle=read(
        ...
        assertTrue(gradle.contains("versionCode 23467"));assertTrue(gradle.contains(
                "versionName '2.34.6.7'"));assertTrue(gradle.contains("NMC Stable 6.7"));
        assertTrue(workflow.contains("NMC v2.34.6.7 Stable CI"));assertTrue(workflow.contains(
                "NMC-v2.34.6.7-stable-apk"));assertEquals("NMC_CAUSAL_MARKET_CAPTURE_V4",
