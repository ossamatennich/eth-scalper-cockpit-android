...
public final class V23451CaptureDeliveryConfigurationTest {
    @Test public void releaseIdentityAndCaptureSchemaAreExact()throws Exception{String gradle=read(
        ...
        assertTrue(gradle.contains("versionCode 23451"));assertTrue(gradle.contains(
                "versionName '2.34.5.1'"));assertTrue(gradle.contains("NMC Stable 5.1"));
        assertTrue(workflow.contains("NMC v2.34.5.1 Stable CI"));assertTrue(workflow.contains(
                "NMC-v2.34.5.1-stable-apk"));assertEquals("NMC_CAUSAL_MARKET_CAPTURE_V2",
                MicrostructureMarketRecord.SCHEMA);assertEquals(2,MicrostructureMarketRecord.FORMAT_VERSION);}
